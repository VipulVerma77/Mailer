  ...
  return (
    ...
    <div className="bg-white py-20">
      <div className="container mx-auto px-4">
        ...
        <div className="flex flex-col items-center justify-center px-20 lg:flex-row gap-12">
          {/* Contact Form */}
          <div className="w-full lg:w-1/2">
            {/* <h2 className="text-3xl font-bold mb-4">Our Contact Form</h2> */}
            {/* <p className="text-gray-600 mb-6">
              The contact form is currently inactive. <a className="text-blue-600 font-semibold" href="https://htmlcodex.com/contact-form">Download Now</a>.
            </p> */}
          ...
          <div className="w-full lg:w-1/2 space-y-6">
            {[
              ...
              <div key={idx} className="flex items-center">
                <div className="bg-gray-100 w-[90px] h-[90px] rounded-full flex items-center justify-center text-pink-600 text-2xl">
                  {item.icon}
                </div>
                <div className="ml-6">
